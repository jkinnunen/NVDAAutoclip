...
- **Työkalut-valikko**: NVDA-valikko -> Työkalut -> Puhu leikepöydän sisältö automaattisesti.

## Asetukset

Asetuksia muutetaan NVDA:n asetusvalintaikkunan "Automaattinen leikepöydän puhuminen" -kategoriasta.

- **Keskeytä ennen leikepöydän sisällön puhumista**: Keskeytetäänkö senhetkinen puhe ennen leikepöydän sisällön lukemista
- **Muista automaattisen leikepöydän puhumisen tila NVDA:n uudelleenkäynnistyksen jälkeen**: Säilytä leikepöydän puhumisen tila myös uudelleenkäynnistysten välillä (tarvitaan asetusprofiileissa)
...
- **Yritä katkaista osat sanojen rajakohdissa**: Kun tekstin jakaminen on käytössä, teksti jaetaan välilyöntien kohdalta sanan katkeamisen estämiseksi (oletuksena käytössä)
...
- **Saman tekstin puhumiseston viive**: Estää saman sisällön toistumisen tämän ajan sisällä (millisekunteina, oletus on 100, 0 poistaa käytöstä, -1 ei koskaan toistoa)
...
- **Palauta lisäasetusten oletukset**: Palauta lisäasetusten oletukset
